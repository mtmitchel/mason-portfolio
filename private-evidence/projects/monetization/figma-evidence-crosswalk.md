...
- `MON-06` is a direct-source June–July 2024 Translator grid workshop and
  proposal. The record supports Mason's constraints and corrections, not
  authorship of generated suggestions. No exact canonical Figma node upgrades
  it from working proposal to production evidence.
- `MON-05` supports workshop activity, working artifacts, constraints, and
