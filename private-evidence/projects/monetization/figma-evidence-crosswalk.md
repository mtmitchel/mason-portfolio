# Monetization Figma evidence crosswalk
...
- Preserved source file:
  <https://www.figma.com/design/0JYwhKhRAliGBhyl2kBnEu/Monetization>.
- Recovery records: `MON-01` through `MON-06`, `SYS-01`, `SYS-03`, and
  `SYS-04` in the
  [`achievement ledger`](../../deepl-achievement-recovery/artifacts/achievement-ledger.json).
- Direct pricing conversations and attachments:
  [`pricing-evolution/gpt-export-evidence/`](../pricing-evolution/gpt-export-evidence/README.md).

Mason's current account establishes collaborative involvement across the
recovered Monetization and product-design context. Exact node-to-deliverable
mapping still matters for captions and lifecycle, but missing contributor
metadata is not a reason to exclude a family from portfolio consideration.
...
- `MON-05` supports Mason's collaborative conception, writing, editing,
  ...
  establish which variant shipped.
...
- Voice and API plan frames establish visible product context. Mason's account
  supports collaborative involvement in the wider work; their omission from a
  pricing story should be based on focus and reader value, not a missing
