...
in reserve as a possible writing sample; terminology belongs to the
content-system record. The pricing case does not use `MON-05` as a second
Mason-contribution thread.

## Complete Step 18 family allocation
...
| Other project owners | `AR-01`, `AR-02` | Keep MFA material with Account Security and administrative material with Team Administration. These records do not belong in the pricing case. Mason confirmed their visible user and account data is mock; internal identifiers and unfinished states still need selection review. |
...
Use the genuine 2024 working sequence as the primary visual evidence:

1. `gpt-export-evidence/attachments/file-tWhO0PSkFda3Tfh3Hi24u5rQ.png` — the
   repeated-list working state;
...
`file-6sayxJnNtubSmRj1uVQfSzuD.png` private because Mason rejects the impression
