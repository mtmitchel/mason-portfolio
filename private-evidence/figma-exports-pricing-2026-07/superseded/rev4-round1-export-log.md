...
- Cluster D is the full-page beginning-state exhibit. Card and comparison-table
  ...
  is supported by `Monetization/Translator@2x.png` and
  `figma screenshots/1920px.png`. Historical prices were retained.
...
- Cluster E was completed with instance overrides only. The source line
  ...
  `Monetization/API.png`, including the historical `€20.00` per 1,000,000
