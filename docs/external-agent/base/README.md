...
External-context version: `2026-08-03.3`
...
## Persistent provider set

Install the complete contents of `PROJECT_INSTRUCTIONS.txt` plus these files,
once each:
...
- `PROJECT_INSTRUCTIONS.txt` — provider-field essentials and authorization
  boundary.
