...
- [`retired/assets/`](retired/assets/) — public or working assets retired during
  source-fidelity and story-selection corrections.
...
- [`retired/public-assets/`](retired/public-assets/) — assets removed from the
  deployable site.
- [`retired/source-dumps/`](retired/source-dumps/) — superseded or misleading
  source-capture attempts retained for provenance.
