...
- `private-evidence/`, `claim-review.md`, `archive/`, `private-evidence/source-exports/figma/monetization-pricing-pages/`,
  `private-evidence/source-exports/figma/pricing-page-screenshots/`, and the root CV are working material and reference
